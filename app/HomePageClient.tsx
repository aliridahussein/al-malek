...
const TikTokIcon = () => (
  <svg viewBox="0 0 32 32" width="24" height="24" fill="white" xmlns="http://www.w3.org/2000/svg">
    <path d="M19.792 3.333c.23 1.94 1.289 3.808 2.862 4.973 1.15.852 2.526 1.345 3.974 1.42v4.09a11.29 11.29 0 01-6.028-1.756v8.017c0 4.62-3.676 8.39-8.236 8.59a8.585 8.585 0 01-6.098-2.104A8.675 8.675 0 013.333 20.33c0-4.766 3.85-8.627 8.592-8.627.46 0 .918.037 1.367.11v4.207a4.507 4.507 0 00-1.367-.213c-2.402 0-4.35 1.954-4.35 4.364 0 1.681.947 3.208 2.441 3.94a4.328 4.328 0 002.52.396c2.085-.278 3.732-2.071 3.732-4.247V3.333h3.524z" />
  </svg>
);
  ...
  return (
    <main className="min-h-dvh flex flex-col items-center relative overflow-hidden px-4 pb-12 pt-10">
      ...
      <div className="relative z-10 w-full max-w-sm flex flex-col items-center gap-6">
        ...
        {campaignActive ? (
          <motion.div custom={3.5} variants={fadeUp} initial="hidden" animate="show" className="w-full rounded-[28px] px-5 py-5 text-center" style={{ background: "linear-gradient(140deg, rgba(255,255,255,0.88) 0%, rgba(255,242,247,0.94) 100%)", border: "1.5px solid rgba(255,77,141,0.18)", boxShadow: "0 16px 50px rgba(255,77,141,0.14), 0 6px 16px rgba(129,52,175,0.08)" }}>
            <p className="text-sm font-extrabold uppercase tracking-[0.28em]" style={{ color: "#FF4D8D" }}>
              {content.campaign_badge_label || "Prize Window"}
            </p>
            <h2 className="mt-3 text-xl font-black leading-tight" dir="rtl" style={{ color: "#1A0A2E", fontFamily: '"Segoe UI", Tahoma, sans-serif' }}>
              {content.campaign_form_title}
            </h2>
            {content.campaign_form_description ? (
              <p className="mt-2 text-sm leading-6" dir="rtl" style={{ color: "#3D1A6E" }}>
                {content.campaign_form_description}
              </p>
            ) : null}
